# 🛡️ LIVE PROOF EXECUTION RULES

To maintain absolute integrity and focus for this repository, the following rules are MANDATORY:

### 🚫 PROHIBITED (KHÔNG)
- **❌ Không nói AI học**: We do not discuss training, epochs, or "learning" during this phase. Focus on execution only.
- **❌ Không backtest**: No historical simulations or theoretical results.
...
- **✅ Hard Lock**: Cơ chế khóa cứng toàn hệ thống, chỉ cho phép DUY NHẤT một tín hiệu hoạt động tại một thời điểm.
